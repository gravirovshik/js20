...
function t10() {
    ...
    document.querySelector('div.out-10').innerHTML = data * 10;
}
...
function t12() {
    let name = document.querySelector('.i-12-1').value; // получили имя
    let surname = document.querySelector('.i-12-2').value; // получили имя
...
function t13() {
    ...
    document.querySelector('div.out-13').innerHTML = a + b;
}
...
function t16() {
    ...
    document.querySelector('div.out-16').innerHTML = a + b;
}
...
function t19() {
    ...
    document.querySelector('div.out-19').innerHTML = a + b;
}
