...
function t1() {
    ...
    document.querySelector('.out-1').innerHTML = t1s;
}
...
function t2() {
    ...
    document.querySelector('.out-2').innerHTML = t2s;
}
...
function t3() {
    ...
    document.querySelector('.out-3').innerHTML = t3s;
}
...
function t4() {
    ...
    document.querySelector('.out-4').innerHTML = t4s;
}
...
function t5() {
    ...
    document.querySelector('.out-5').innerHTML = t5s;
}
...
//  Task 13
// С помощью цикла присвойте всем input .i-13 va2lue равное 1 для первого, 2 для второго и 3 для третьего.

function t13() {

    let in13 = document.getElementsByClassName('i-13');

    for (let i = 1; i <= in13.length; i = i + 1) {
        in13[i - 1].value = i;
    }
...
function t14() {
    let in14 = document.getElementsByClassName('i-14');
    // console.log(in14);
    for (let i = 0; i < in14.length; i = i + 1) {
        if (in14[i].checked) {
            document.querySelector('.out-14').innerHTML = in14[i].value;
        }
    }
}
...
function t15() {
    for (let i = 0; i <= 10; i = i + 1) {
        t10s = t10s + (10 - i) + '_' + i + '_';
    }
    document.querySelector('.out-15').innerHTML = t10s;
}
